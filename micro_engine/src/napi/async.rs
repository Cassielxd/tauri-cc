...
#[napi_sym::napi_sym]
fn napi_create_async_work(_env: *mut Env, _async_resource: napi_value, _async_resource_name: napi_value, execute: napi_async_execute_callback, complete: napi_async_complete_callback, data: *mut c_void, result: *mut napi_async_work) -> napi_status {
  let mut work = AsyncWork { data, execute, complete };
...
#[napi_sym::napi_sym]
fn napi_cancel_async_work(_env: &mut Env, _async_work: napi_async_work) -> napi_status {
  napi_ok
}

/// Frees a previously allocated work object.
#[napi_sym::napi_sym]
fn napi_delete_async_work(_env: &mut Env, work: napi_async_work) -> napi_status {
...
#[napi_sym::napi_sym]
fn napi_queue_async_work(env_ptr: *mut Env, work: napi_async_work) -> napi_status {
...
#[napi_sym::napi_sym]
fn napi_async_init(env: *mut Env, _async_resource: napi_value, _async_resource_name: napi_value, result: *mut *mut ()) -> napi_status {
  check_env!(env);
  *result = ptr::null_mut();
  napi_ok
}
