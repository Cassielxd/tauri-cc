...
unsafe fn get_backing_store_slice(backing_store: &mut v8::SharedRef<v8::BackingStore>, byte_offset: usize, byte_length: usize) -> &mut [u8] {
...
pub fn get_array_buffer_ptr(ab: v8::Local<v8::ArrayBuffer>) -> *mut u8 {
  ...
  let mut slice = unsafe { get_backing_store_slice(&mut backing_store, 0, byte_length) };
  slice.as_mut_ptr()
}
