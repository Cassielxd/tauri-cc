...
pub async fn create_cli_npm_resolver_for_lsp(options: CliNpmResolverCreateOptions) -> Arc<dyn CliNpmResolver> {
...
pub async fn create_cli_npm_resolver(options: CliNpmResolverCreateOptions) -> Result<Arc<dyn CliNpmResolver>, AnyError> {
  use CliNpmResolverCreateOptions::*;
  match options {
